...
def get_sales_data():
    ...
    Run a while loiop to collect a valid string of data from the user
...
def update_sales_worksheet(data):
    """
    update sales wo4rksheet, add new row with the list data provided.
    """
...
def update_surplus_worksheet(new_surplus_data):
    """
    Updates surplus worksheet with new surplus data
    """
